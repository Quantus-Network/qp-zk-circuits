...
1. **GitHub private security advisory (preferred).**
   [Report a vulnerability](https://github.com/quantus-network/qp-zk-circuits/security/advisories/new).
...
**In scope:** the zero-knowledge circuits in this repository — soundness bugs, under-constrained circuits, or acceptance of forged or invalid proofs.
