...
pub const DEFAULT_TO_ACCOUNTS: [[u8; 32]; 2] = [
    [
        222, 104, 198, 252, 179, 227, 141, 103, 54, 183, 154, 1, 14, 69, 4, 185, 140, 99, 33, 241,
        228, 209, 28, 216, 72, 79, 103, 193, 135, 202, 9, 14,
    ],
    [
        45, 207, 75, 148, 76, 19, 218, 49, 167, 72, 237, 4, 162, 81, 85, 125, 155, 251, 142, 237,
        124, 74, 138, 245, 89, 60, 89, 214, 20, 38, 66, 183,
    ],
];
...
impl TestInputs for CircuitInputs {
    fn test_inputs_0() -> Self {
        ...
        let unspendable_account =
            digest_to_bytes(UnspendableAccount::from_secret(secret).account_id);
...
pub mod storage_proof {
    ...
    pub const DEFAULT_ROOT_HASHES: [&str; 2] = [
        "8d2a9bb79d8342a0d4f429a6988ab09dbe4df4954477a69e6274e4c8d4771a85",
        "42d2c6e50e1e653f860605fec4220dee9c9fd469dac7b7eff129f1f6e98bbaf2",
    ];

    pub const DEFAULT_STORAGE_PROOF_A: [&str; 8] = [
        "",
        "0000000000000020041000000000000020000000000000006306b67a1162fdcde5e5924341f62f752de723f44d7882fc9f2d651aa207d5112000000000000000b7361080961b2d3b348d96affbf10c7ee2d6416efa14b524289e264863a270b6",
        "",
        "000000000000002084000000000000002000000000000000dd262e1aabe9187a7b316febb7adfa40e8b62454bdb19862d98060eb590b73f12000000000000000abf9dfa05f2adc8c6b9447a6dae41d898ac8d77d683c8fe8c9a563a0cd05e0d7",
        "",
        "0000000000000020a0000000000000002000000000000000439f73a9fe5a17162de32efd7abca06f0c880dc966613afdcf1ab350e1619c4a2000000000000000f20db5c7b9adeeeda53c444bc087c6adcb3149610549a9008a5db20de6b71ea0",
        "3e00000000000050a6efa8eb17713f29bca436a249ed4921133ef835b8c67f6a8212511e2af17fde0000000000000000",
        "6a38dd08e7edfe5910f7a2a1abccea8b584930fc0a94d9bfd77332972eb63eb9",
    ];
    pub const DEFAULT_STORAGE_PROOF_B: [&str; 9] = [
        "",
        "000000000000002004100000000000002000000000000000a395037ea9fe70a0c84425d0af8f5d2c31ea12efa0e90a39e494a0ba8db77c6a2000000000000000b7361080961b2d3b348d96affbf10c7ee2d6416efa14b524289e264863a270b6",
        "",
        "00000000000000208400000000000000200000000000000054e36b428ffcd346cd2c488d85b70f9f8122c34740476d9ca5e941d6d2e4918e200000000000000028eebda41303bbdd9f64f5a36e1ce338b6bacdaee99fb13ee344c067365459b3",
        "",
        "",
        "000000000000002040800000000000002000000000000000abd37eb94210d0719aa070a4f9d0d6b4fbde0404088c4202b2f09e15d8ecf28920000000000000007ef6c95f5ccf1ee1834e5c7123ee918d619b05e1f26e53d50f6cc5d34ca7c06b",
        "3d00000000000050dd81a9c3e9c6a04160ad83a07901ab588a0fd75d6be8c4395401a75af7007b780000000000000000",
        "36417c119d9f6b6104f36099ce9aa929de3269a170198eb507f960301fc1e375",
    ];
...
pub mod block_header {
    ...
    pub const DEFAULT_BLOCK_HASHES: [[u8; 32]; 2] = [
        [
            46, 3, 21, 128, 100, 17, 63, 118, 86, 230, 175, 252, 71, 205, 211, 220, 251, 93, 207,
            189, 85, 220, 77, 96, 75, 73, 188, 186, 21, 196, 203, 56,
        ],
        [
            207, 190, 101, 110, 208, 30, 177, 35, 61, 169, 119, 57, 20, 237, 91, 158, 89, 227, 114,
            247, 134, 201, 102, 153, 59, 235, 14, 38, 64, 19, 216, 253,
        ],
    ];
