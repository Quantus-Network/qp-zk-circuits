...
pub mod block_header {
    ...
    pub const DEFAULT_BLOCK_HASHES: [[u8; 32]; 2] = [
        [
            118, 229, 243, 121, 101, 200, 184, 46, 44, 82, 140, 230, 161, 166, 190, 208, 149, 54,
            3, 28, 0, 109, 106, 179, 222, 1, 48, 104, 43, 246, 17, 252,
        ],
        [
            242, 66, 185, 198, 65, 118, 134, 231, 230, 89, 219, 7, 78, 129, 118, 108, 232, 195, 47,
            158, 250, 205, 52, 72, 151, 67, 145, 143, 121, 169, 185, 165,
        ],
    ];
