//! Compact-child inner aggregation circuit for the 2x8 layer-0 topology.
//!
//! This is the first proving stage in the compact-child layer-0 flow:
...
/// Runtime targets for the compact-child inner aggregation circuit.
#[derive(Debug, Clone)]
